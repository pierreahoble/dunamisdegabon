    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
		  ...
		  ou soummettre votre projet avec détails en remplissant le formulaire <a type="button" class="btn btn-warning" href="{{route('choisir-projet')}}" style="color:#fff"><i class="icofont-aim"></i> Soumettre mon projet</a></p>
        </div>
		<div class="row">
		<div class="col-lg-12">
		  @if (session('status'))
			...
			<div class="form-row">
				...
				<label class="label-control">Sélectionner une catégorie<font color="red">*</font></label>
                  <select id="niveau" type="text" class="form-control" name="langue" required>
					<option value="">Veuillez sélectionner</option>
					<option value="">Agriculture</option>
					<option value="">Elevage</option>
					<option value="">Transport et Logistique</option>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up">
			  ...
			  <img src="{{asset("public/storage/".$projets->fichier)}}" alt="" class="img-fluid"/>
                <div class="social">
                  <a type="button" class="btn btn-success" href="https://api.whatsapp.com/send?phone=00241077816737&text=Bonjour,%20je suis%20interessé%20par%20le%20projet : {{$projets->libelle}}" target="_blank" style="color:#fff;"> <i class="icofont-whatsapp"></i> En savoir plus</a>
                </div>
              </div>
