@extends('layout2')
@section('title','Liste des demandes fermées')
@section('content')
<!-- ======= Breadcrumbs ======= -->
    <section id="breadcrumbs" class="breadcrumbss">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2><i class="icofont-folder-open"></i> Liste des demandes fermées</h2>
          <ol>
            <li>
		...
		@endif
            ...
            <li>Liste des demandes fermées</li>
          </ol>
        </div>
