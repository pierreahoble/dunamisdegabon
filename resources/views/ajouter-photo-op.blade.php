@extends('layout2')
@section('title', 'Mettre à jour photo')
@section('content')
<!-- ======= Breadcrumbs ======= -->
	...
	<div class="container">
		<div class="row mt-12" data-aos="fade-up">
			<div class="col-lg-12">
				...
				@endif
				<form method="post" action="{{route('opphotopost')}}" role="form" class="php-email-form"
					enctype="multipart/form-data">
					{{csrf_field()}}
					<br />
					<div class="form-row">
						<div class="col-md-5 form-group">
							<label class="label-control">Importer votre photo<font color="red">*</font></label>
