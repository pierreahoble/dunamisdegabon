	...
	<div class="container">
		...
		<div class="row mt-5 justify-content-center" data-aos="fade-up">
			<div class="col-lg-6">
				...
				<br />
				<form method="post" action="{{route('pubPost')}}" role="form" class="php-email-form"
					...
					<div class="form-row">
						...
						<div class="col-md-12 form-group">
							...
							<input id="titre" type="text" class="form-control" name="titre"
								placeholder="Veuillez saisir le titre" required>
							<div class="validate"></div>
						</div>
						<div class="col-md-12 form-group">
							<label class="label-control">Contenu de la publication</label>
							<textarea class="form-control" name="contenu" rows="10" data-rule="required"
								data-msg="Veuillez saisir le contenu"></textarea>
							<div class="validate"></div>
						</div>
