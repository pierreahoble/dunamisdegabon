			...
			<div class="form-row">
                   <div class="form-group col-lg-6">
                    ...
                    <select class="form-control" name="projet" id="projet" required>
						...
						<option value="{{$projets->id}}">{{$projets->libelle}}</option>
						@endforeach
						<option value="0">Autres</option>
					</select>
					</div>
					<div class="col-md-12 form-group" id="autre_projet">
				<label class="label-control">PRÉCISER VOTRE PROJET <font color="red">*</font></label>
                  <input id="autre" type="text" class="form-control" name="autre" placeholder="">
                </div>
                </div> 
	   ...
	   $("#profil").select2({
		...
		<script>
			...
			$('select[name="projet"]').change(function(){
				...
				var projet = $("select[name=projet]").val();
