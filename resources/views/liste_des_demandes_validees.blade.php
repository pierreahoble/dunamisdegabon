@extends('layout2')
@section('title','Liste des demandes validées et clôturées')
@section('content')
<!-- ======= Breadcrumbs ======= -->
    <section id="breadcrumbs" class="breadcrumbss">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2><i class="icofont-folder-open"></i> Liste des demandes validées et clôturées</h2>
          <ol>
            <li>
		...
		@endif
            ...
            <li>Liste des demandes validées et clôturées</li>
          </ol>
        </div>
	...
	@if (session('status'))
        ...
        @endif
	        <br>
			<h2 align="center">
             Liste des demandes validées et clôturées
            </h2>
			 <br>
            <div class="table-responsive table-hover container">
				<table border="1" style="width:1300px;">
					...
					<td>
					<a target="_blank" href="{{route('fiche-demande-projet', ['id' =>$projets->id])}}" style="color:blue;height:25px;width:25px;">
                                    <i class="icofont-eye" style="height:25px;width:25px;"></i>
                    </a>
					<a target="_blank" href="{{url("storage/".$projets->fichier)}}" style="color:brown;">
