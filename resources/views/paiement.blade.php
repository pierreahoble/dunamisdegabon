    ...
    <section id="contact" class="contact">
      <div class="container">
		<div style="background-color:#fff;padding:15px;margin-top:-45px;">
		  ...
		  <form method="post" action="{{route('paiement-post', ['id'=>$id])}}" role="form" class="php-email-form" enctype="multipart/form-data">
            {{csrf_field()}}
			<br/>
		  ...
		  @if (session('status'))
			...
			<br/>
              ...
              <div class="form-row">
				...
				@endphp
                  <input id="code_client" type="text" class="form-control" value="{{$nom}} {{$prenom}}" placeholder="Veuillez saisir le code du client" readOnly>
