   ...
   <!-- End Breadcrumbs --><br/><br/><br/><br/>
    <section id="contact" class="contact">
      <div class="container">
		...
		<br/><br/><br/><br/><br/><br/>
		<center> Votre inscription s'est bien déroulé avec succès, <br/>veuillez vous connecter pour complèter les informations de votre profil.<br/><br/>
		<a type="button" class="btn btn-success" href="{{route('login')}}"><i class="icofont-login"></i> Connexion </a>
		</center>
        </div>
		</div>
      </div>
